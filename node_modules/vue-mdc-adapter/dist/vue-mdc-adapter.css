...
.mdc-button--stroked .mdc-button .mdc-icon, .mdc-button
.mdc-button--stroked .mdc-icon {
  /* @noflip */
  margin-left: -4px;
  /* @noflip */
  margin-right: 8px; }
  ...
  .mdc-button--stroked .mdc-button .mdc-icon, .mdc-button [dir="rtl"]
  .mdc-button--stroked .mdc-icon,
  .mdc-button--stroked .mdc-button__icon[dir="rtl"],
  .mdc-button--stroked .mdc-button [dir="rtl"].mdc-icon, .mdc-button
  .mdc-button--stroked [dir="rtl"].mdc-icon {
    /* @noflip */
    margin-left: 8px;
    /* @noflip */
    margin-right: -4px; }
...
.mdc-drawer--persistent {
  ...
  .mdc-drawer--persistent.mdc-drawer--animating .mdc-drawer__drawer {
    -webkit-transition: -webkit-transform 200ms 0ms cubic-bezier(0.4, 0, 0.2, 1);
